...
class ContractorManager(Container):
    ...
    def generateZpkNumber(self, obligation):
        ...
        zpkContractor.getCurrentBalance().setStartCredit(float(self._svars.get('startCredit')))
        zpkContractor.getCurrentBalance().setStartDebit(float(self._svars.get('startDebit')))
        zpkContractor.getCurrentBalance().setCredit(zpkContractor.getCurrentBalance().getStartCredit())
        zpkContractor.getCurrentBalance().setDebit(zpkContractor.getCurrentBalance().getStartDebit())
