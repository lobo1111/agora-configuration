...
class ContractorManager(Container):
    ...
    def generateZpkNumber(self, obligation):
        ...
        manager.setStartBalance(zpkContractor, float(self._svars.get(self._prefix + 'startCredit2')), float(self._svars.get(self._prefix + 'startDebit2')))
        ...
        manager.setStartBalance(zpkCost, float(self._svars.get(self._prefix + 'startCredit5')), float(self._svars.get(self._prefix + 'startDebit5')))
