...
class PossessionManager(Container):
    ...
    def generateZpkNumber(self, possession):
        ...
        zpkRent.getCurrentBalance().setCredit(zpkRent.getCurrentBalance().getStartCredit())
        zpkRent.getCurrentBalance().setDebit(zpkRent.getCurrentBalance().getStartDebit())
