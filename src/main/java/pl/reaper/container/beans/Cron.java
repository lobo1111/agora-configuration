...
public class Cron implements CronLocal {
    ...
    @Schedule(minute = "*", second = "0", dayOfMonth = "*", month = "*", year = "*", hour = "*", dayOfWeek = "*", info = "Script Scheduler", persistent = false)
    ...
    private void executeScript(ScriptScheduler scriptScheduler) {
        jythonBean.executeScript(scriptScheduler.getName(), new HashMap<String, Object>());
    }
}
