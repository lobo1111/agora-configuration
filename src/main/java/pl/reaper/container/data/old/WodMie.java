...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "WodMie.findAll", query = "SELECT w FROM WodMie w")})
public class WodMie implements Serializable {
    ...
    public WodMie(Integer id) {
        this.id = id;
    }

    public WodMie(Integer id, String md5) {
        this.id = id;
        this.md5 = md5;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof WodMie)) {
            return false;
        }
        WodMie other = (WodMie) object;
    ...
    public String toString() {
        return "pl.reaper.container.data.old.WodMie[ id=" + id + " ]";
    }
