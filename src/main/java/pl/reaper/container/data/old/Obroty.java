...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Obroty.findAll", query = "SELECT o FROM Obroty o")})
public class Obroty implements Serializable {
    ...
    public Obroty(Integer id) {
        this.id = id;
    }

    public Obroty(Integer id, String md5) {
        this.id = id;
        this.md5 = md5;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Obroty)) {
            return false;
        }
        Obroty other = (Obroty) object;
    ...
    public String toString() {
        return "pl.reaper.container.data.old.Obroty[ id=" + id + " ]";
    }
