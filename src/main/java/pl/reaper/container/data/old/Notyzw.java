...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Notyzw.findAll", query = "SELECT n FROM Notyzw n")})
public class Notyzw implements Serializable {
    ...
    public Notyzw(Integer id) {
        this.id = id;
    }

    public Notyzw(Integer id, String md5) {
        this.id = id;
        this.md5 = md5;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Notyzw)) {
            return false;
        }
        Notyzw other = (Notyzw) object;
    ...
    public String toString() {
        return "pl.reaper.container.data.old.Notyzw[ id=" + id + " ]";
    }
